...
LLM의 학습 데이터 최신성 한계를 보완하고, 특정 프레임워크의 중요한 변경 사항을 정확히 반영하기 위해 다음 폴더에 큐레이션된 문서를 관리하고 있습니다.

* 위치: `.framework-updates/` 폴더
* 내용: 이 폴더에는 `[프레임워크명]-[년도]-q[분기].md` 형식으로 각 프레임워크의 분기별 주요 패치 내용 및 개발자가 알아야 할 변경 사항이 요약되어 있습니다.
* 활용 지침: 문제에 봉착해 context7을 사용하기 전에 도움이 필요하다 판단되면, 이 폴더 내의 관련 문서들을 참고해 답변하십시오.
