...
describe("site localization", () => {
	...
	it("keeps visible UI labels localized for every supported language", () => {
		...
		expect(enMessages.indiehackers_tag_label).toBe("Tag");
		expect(enMessages.indiehackers_all_tags).toBe("All tags");
		expect(enMessages.indiehackers_year_label).toBe("Year");
		expect(enMessages.indiehackers_all_years).toBe("All years");
		expect(enMessages.indiehackers_apply_filters).toBe("Apply");
		...
		expect(enMessages.indiehackers_back_to_list).toBe("Back to list");
		...
		expect(koMessages.indiehackers_year_label).toBe("연도");
		expect(koMessages.indiehackers_all_years).toBe("전체 연도");
		expect(koMessages.indiehackers_apply_filters).toBe("적용");
		expect(koMessages.indiehackers_clear_filters).toBe("초기화");
